<template>
  <div>
    <div class="hx-main-container hx-customize-network-container">
      ...
      <div v-if="!customizeNetworkDone">
        <el-form
          ...
          label-width="90pt"
          class="hx-customize-network-inner-container"
        >
      ...
      <div v-if="customizeNetworkDone" class="hx-customize-network-done-container">
...
<style lang="less">
.hx-customize-network-container1 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.hx-customize-network-container2 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.hx-customize-network-container,
.hx-customize-network-done-container {
  min-width: 400px;
  min-height: 266pt;
