<template>
  <div>
    <div class="hx-main-container hx-contract-container">
      <div class="-nav-side">
        <SideNavbar
          :items="navbarItems"
      ...
      <RegisterContract v-if="selectedNavbarItem==='deploy'"></RegisterContract>
      <InvokeContract v-if="selectedNavbarItem==='invoke'"></InvokeContract>
      <TransferToContract v-if="selectedNavbarItem==='transfer'"></TransferToContract>
    </div>
  </div>
</template>
...
.hx-contract-inner-container,
.hx-contract-done-inner-container {
  width: 400pt;
